              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title"> Running Booking List  </h4>
                    <?php } else { ?>
						...
						ng-if="x.show>0 && x.providername==''" <?php }else {"";}?> >
						 ...
						 ?>
                                        	...
                                        	<span ng-if="x.show==0"><i style="color:#000!important;" class="fa fa-square-o icon" ng-show="x.flag==false" aria-hidden="true"></i><i style="color:#000!important;" class="fa fa-check-square-o icon" ng-show="x.flag==true" aria-hidden="true"></i></span> <span style="color:red;font-weight:bold;" ng-if="x.show!=0">Request Send</span></td>
                                             ...
                                             <?php } else { ?>
                                             <td>
                                                    <span ng-if="x.cstatus==0 && x.providername==''">{{x.desti}}</span>
                                             </td>
		...
		$http.post("api/getDataToday.php",1).then(function(response) {
			...
			if(obj.providername==null){
				...
				var show = obj.show;
						...
						$scope.bookList.push({"flag":false,"id":obj.id,"personname":obj.personname,"mobile":obj.mobile,"zone":obj.zone,"place":obj.place,"time":obj.time,"date":obj.date,"seat":obj.seat,"created_at":obj.created_at,"show":show,"providername":provider ,"providermobile":vmobile,"cstatus":obj.cstatus,"desti":obj.desti,"btype":obj.btype});
			})
