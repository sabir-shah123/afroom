              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title"> Running Ride List  </h4>
                    <?php } else { ?>
						...
						ng-if="x.show>0 && x.providername==''" <?php }else {"";}?> >
						 ...
						 ?>
                                            ...
                                            <td><span ng-if="x.show>0 && x.cstatus==1">{{x.mobile}}</span></td>
                                             <?php } else { ?>
                                             <td><button ng-if="x.cstatus==0 && x.providername!=''" ng-click="statusV([[x.id]])" class="btn btn-success">Accept</button>
                                                    <span ng-if="x.cstatus==0 && x.providername==''">Destination</span>
	...
	$scope.bookingList = function(){
		...
		$http.post("api/getDataToday.php",1).then(function(response) {
			...
			if(obj.providername==null){
				...
				var provider = obj.providername;
				var vmobile = obj.providermobile;
				var show = obj.show;
			}
						$scope.bookList.push({"flag":false,"id":obj.id,"personname":obj.personname,"mobile":obj.mobile,"zone":obj.zone,"place":obj.place,"time":obj.time,"date":obj.date,"seat":obj.seat,"created_at":obj.created_at,"show":show,"providername":provider ,"providermobile":vmobile,"cstatus":obj.cstatus});
			})
